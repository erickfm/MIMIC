...
CHARACTERS: list[CharacterEntry] = [
    ...
    CharacterEntry(
        ...
        display="Falco",
        melee_enum="FALCO",
        checkpoint=REPO_ROOT / "checkpoints/falco-7class-v2-full_best.pt",
    ...
    CharacterEntry(
        ...
        checkpoint=REPO_ROOT / "checkpoints/cptfalcon-7class-v2_best.pt",
    ...
    CharacterEntry(
        ...
        display="Luigi",
        melee_enum="LUIGI",
        checkpoint=REPO_ROOT / "checkpoints/luigi-7class-v2-long_best.pt",
