# Vendored verbatim from the official SOAP reference implementation:
#   https://github.com/nikhilvyas/SOAP  (soap.py), MIT-licensed.
# SOAP = "Improving and Stabilizing Shampoo using Adam" (Vyas et al.,
# https://arxiv.org/abs/2409.11321) — runs Adam in the Shampoo eigenbasis.
# Used by MIMIC's train.py behind `--optimizer soap` as a drop-in AdamW
# alternative for the "better optimizer at equal compute" experiment.
# Do not edit — keep in sync with upstream.
import torch
